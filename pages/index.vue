<template>
   <div class="card text-black flex items-center justify-center h-[30rem] w-[60rem]">
      ...
      <div class="card-actions">
         <button @click="timeIn" class="btn btn-circle btn-ghost w-36 h-36 mt-1 bg-clock_in_green text-white"> <NuxtLink to="/otp">Time In</NuxtLink></button>
      </div>
      <div class="card-actions">
         <button @click="timeIn" class="btn btn-circle btn-ghost w-36 h-36 mt-1 bg-clock_in_green text-white"> Time In</button>
      </div>
      <div @click="signOut" class="card-actions self-end mt-24">
